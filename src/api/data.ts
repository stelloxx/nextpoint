...
export const tours: Tour[] = [
  ...
  { id: '3', name: 'South Bank Art & Culture', city: 'London', duration: '3 hours', type: 'Walking', price: 35, rating: 5.0, hashtags: ['Art', 'Instagram'], imageUrl: 'https://images.unsplash.com/photo-1580997840893-6b4ecafa5cf7?w=800&h=400&fit=crop' },
  ...
  { id: '5', name: 'Hidden Gems of East London', city: 'London', duration: '2 hours', type: 'Walking', price: null, rating: 4.9, hashtags: ['HiddenGems', 'Art'], imageUrl: 'https://images.unsplash.com/photo-1506905925345-21b2f937b534?w=800&h=400&fit=crop' },
  { id: '6', name: 'Hyde Park & Nature Walk', city: 'London', duration: '1.5 hours', type: 'Walking', price: null, rating: 4.6, hashtags: ['Nature', 'Instagram'], imageUrl: 'https://images.unsplash.com/photo-1580997840893-6b4ecafa5cf7?w=800&h=400&fit=crop' },
];
...
export const places: Place[] = [
  { id: '1', name: 'Hyde Park', distance: '2.5 km', imageUrl: 'https://images.unsplash.com/photo-1580997840893-6b4ecafa5cf7?w=400&h=300&fit=crop', lat: 51.5073, lng: -0.1657 },
...
export const friends: Friend[] = [
  ...
  { id: '4', name: 'Jack', avatarUrl: 'https://images.unsplash.com/photo-1506905925345-21b2f937b534?w=100&h=100&fit=crop' },
];
...
export const activities: Activity[] = [
  ...
  { id: '4', friendName: 'Jack', friendAvatarUrl: 'https://images.unsplash.com/photo-1506905925345-21b2f937b534?w=100&h=100&fit=crop', action: 'saved South Bank Evening Walk', time: '2d ago' },
];
