...
const photoPins = [
  ...
  { id: 4, lat: 51.5075, lng: -0.1657, img: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=120&h=120&fit=crop', label: 'Hyde Park' },
  ...
  { id: 8, lat: 51.5390, lng: -0.1426, img: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=120&h=120&fit=crop', label: 'Camden' },
